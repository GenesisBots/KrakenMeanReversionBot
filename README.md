...
It requires no external services, no overseers, and no AI reviewer — just Python, a config file, and (optionally) Kraken API keys.
...
Price is below the Bollinger mean

RSI is below the max threshold

Volatility is within range

Monte Carlo reversion confidence is high
...
Use paper mode to test before enabling live trading.
You are responsible for your own trading decisions.

💬 Support
Open an issue on GitHub if you:

find a bug

want to request a feature

want help configuring the bot
